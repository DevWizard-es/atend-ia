  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 flex items-center justify-center px-4">
      <div className="w-full max-w-lg">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm font-bold text-slate-400 hover:text-emerald-600 transition-colors mb-10"
        >
        ...
        <div className="bg-white rounded-[2rem] border border-slate-100 shadow-2xl shadow-slate-200/60 overflow-hidden">
          {/* Top gradient banner */}
          <div className="relative h-28 bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 overflow-hidden">
            ...
            <div className="absolute top-4 right-6 flex items-center gap-1.5 px-3 py-1.5 bg-white/15 backdrop-blur rounded-full border border-white/20">
              ...
              <span className="text-white text-[10px] font-black tracking-widest uppercase">GuarapoIA</span>
            </div>
          </div>
          ...
          <div className="px-8 pb-8">
            <div className="relative -mt-12 mb-6">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white text-3xl font-black shadow-xl shadow-emerald-500/30 border-4 border-white">
                YA
              </div>
            </div>
            ...
            <div className="space-y-1 mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-emerald-600">Backend Engineer</span>
              </div>
              <p className="text-sm text-slate-500 font-medium mt-2 leading-relaxed">
                Creador y desarrollador de <strong className="text-slate-700">GuarapoIA</strong> — la plataforma que ayuda a los negocios locales a crecer, captar leads y gestionar su reputación online de forma automática.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-2xl border border-slate-100 hover:border-emerald-200 hover:bg-emerald-50/40 transition-all group"
              >
            ...
            <p className="text-xs text-slate-400 text-center mt-8 font-medium">
              ⚡ Hecho con pasión · GuarapoIA © {new Date().getFullYear()}
            </p>
          </div>
        </div>
      </div>
