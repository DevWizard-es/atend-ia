...
export const metadata: Metadata = {
  title: 'Términos de Uso | GuarapoIA',
  description: 'Términos y condiciones de uso de la plataforma GuarapoIA.',
}
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200 font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-gray-400 text-lg mb-12 leading-relaxed">
          Al registrarte y usar <strong className="text-white">GuarapoIA</strong>, aceptas estos términos en su totalidad.
        </p>
        ...
        <div className="mt-12 p-6 bg-gray-900 rounded-xl border border-gray-800">
          <p className="text-gray-400 m-0 leading-relaxed font-sans">
            ...
            <a href="mailto:legal@guarapoia.app" className="text-emerald-400 font-semibold underline decoration-emerald-400/30">legal@guarapoia.app</a>
          </p>
        </div>
      </main>
...
const sections = [
  {
    ...
    content: 'GuarapoIA es una plataforma gratuita para negocios locales financiada mediante publicidad no intrusiva (Google AdSense) en las páginas públicas de los perfiles de negocio.',
  },
  {
    ...
    content: `Al crear una cuenta confirmas que:
      <ul class="mt-4 pl-5 flex flex-col gap-3 list-disc">
        ...
        <li>Has leído y aceptado nuestra <a href="/privacy" class="text-emerald-400">Política de Privacidad</a>.</li>
      </ul>`,
  },
  {
  ...
  },
  {
    ...
    content: 'GuarapoIA se ofrece gratuitamente a los negocios. A cambio, mostramos anuncios de terceros (Google AdSense) en tus páginas públicas. Aceptas que dichas páginas incluyan publicidad contextual relevante para financiar el mantenimiento del servicio.',
  },
  {
    title: '6. Disponibilidad y garantías',
    content: 'GuarapoIA se proporciona "tal cual" y según disponibilidad. Aunque nos esforzamos por mantener el servicio operativo 24/7, no garantizamos la ausencia de interrupciones técnicas o errores.',
  },
  {
    title: '7. Limitación de responsabilidad',
    content: 'GuarapoIA no será responsable de daños indirectos, pérdida de datos, ingresos o beneficios que puedan derivarse del uso de la herramienta.',
  },
  {
    title: '8. Terminación',
