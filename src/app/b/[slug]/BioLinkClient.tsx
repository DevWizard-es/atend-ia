...
import { MessageCircle, Star, MapPin, Menu as MenuIcon, ChevronRight, Check } from "lucide-react";
import AdSlot from "@/components/AdSlot";
import AIChatWidget from "@/components/AIChatWidget";

export default function BioLinkClient({ slug, initialData }: { slug: string, initialData: any }) {
  const [business, setBusiness] = useState<any>(initialData);
